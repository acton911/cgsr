...
from linux_qss_dial_rate import LinuxQSSDialRate
import sys
import pickle
...
# debug
all_logger.info("LinuxQSSDialRate: {} , type{}".format(LinuxQSSDialRate, type(LinuxQSSDialRate)))
...
params_dict = {
    ...
    'dm_port': dm_port,
    'wwan_path': wwan_path,
    'gobinet_path': gobinet_path,
    'pcie_driver_path': pcie_driver_path,
    'qmi_usb_network_card_name': qmi_usb_network_card_name,
    'mbim_usb_network_card_name': mbim_usb_network_card_name,
    'gobinet_usb_network_card_name': gobinet_usb_network_card_name,
    'ecm_usb_network_card_name': ecm_usb_network_card_name,
    'pcie_network_card_name': pcie_network_card_name,
...
exec("LinuxQSSDialRate(**{}).{}()".format(params_dict, func))
