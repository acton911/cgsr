...
from linux_sms import LinuxSMS
...
# debug
all_logger.info("LinuxSMS: {} , type{}".format(LinuxSMS, type(LinuxSMS)))
...
# 从args_5g中取出对应参数
me_store = args_5g.dev_me_store
sm_store = args_5g.dev_sm_store
sms_phone_number = args_5g.sms_phone_number
# 解压的属性
at_port = main_device['usbat']
dm_port = main_device['upgrade']
debug_port = main_device['debug']
func = script_context['func']
phone_number = main_device['deviceCardList'][0]['phonenumber']
phone_number_pdu = main_device['deviceCardList'][0]['phonenumber_PDU']
phone_number_hex = main_device['deviceCardList'][0]['phonenumber_HEX']
phone_number_ucs2 = main_device['deviceCardList'][0]['phonenumber_UCS2']
sca_number = main_device['deviceCardList'][0]['sca_number']
sim_imsi = main_device['deviceCardList'][0]['sim_imsi']
sim_iccid = main_device['deviceCardList'][0]['sim_iccid']
sim_puk = main_device['deviceCardList'][0]['sim_puk']
...
params_dict = {
    ...
    'phone_number_pdu': phone_number_pdu,
    'phone_number_hex': phone_number_hex,
    'phone_number_ucs2': phone_number_ucs2,
...
exec("LinuxSMS(**{}).{}()".format(params_dict, func))
