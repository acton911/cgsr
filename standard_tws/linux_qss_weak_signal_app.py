...
from linux_qss_weak_signal import LinuxQSSWeakSignal
import sys
import pickle
...
# debug
all_logger.info("LinuxQSSWeakSignal: {} , type{}".format(LinuxQSSWeakSignal, type(LinuxQSSWeakSignal)))
...
exec("LinuxQSSWeakSignal(**{}).{}()".format(params_dict, func))
