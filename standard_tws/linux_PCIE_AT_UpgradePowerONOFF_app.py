...
from linux_PCIE_AT_UpgradePowerONOFF import LinuxATManagerPower
...
# debug
all_logger.info("LinuxATManagerPower: {} , type{}".format(LinuxATManagerPower, type(LinuxATManagerPower)))
...
exec("LinuxATManagerPower(**{}).{}()".format(params_dict, func))
