...
from linux_pcie_efuse_mbim import LinuxPcieEfuseMBIM
import sys
import pickle
...
# debug
all_logger.info("LinuxPcieEfuseMBIM: {} , type{}".format(LinuxPcieEfuseMBIM, type(LinuxPcieEfuseMBIM)))
...
exec("LinuxPcieEfuseMBIM(**{}).{}()".format(params_dict, func))
