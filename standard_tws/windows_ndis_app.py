...
from windows_ndis import WindowsNDIS
...
# debug
all_logger.info("WindowsNDIS: {} , type{}".format(WindowsNDIS, type(WindowsNDIS)))
...
ndis_driver_name = args_5g.dev_ndis_driver_name
...
params_dict = {
    ...
    "ndis_driver_name": ndis_driver_name,
...
try:
    ...
    exec("WindowsNDIS(**{}).{}()".format(params_dict, func))
