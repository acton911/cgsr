...
from linux_eth import LinuxETH
import sys
import pickle
from utils.functions.linux_api import disable_network_card, enable_network_card_and_check
import time
...
# debug
all_logger.info("LinuxETH: {} , type{}".format(LinuxETH, type(LinuxETH)))
...
params_dict = {
    ...
    'rtl8125_ethernet_name': rtl8125_ethernet_name,  # rtl8125 网线连接的网卡名称
...
try:
    ...
    exec("LinuxETH(**{}).{}()".format(params_dict, func))
