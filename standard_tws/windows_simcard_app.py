...
from windows_simcard import WindowsSIMCARD
...
# debug
all_logger.info("WindowsSIMCARD: {} , type{}".format(WindowsSIMCARD, type(WindowsSIMCARD)))
...
exec("WindowsSIMCARD(**{}).{}()".format(params_dict, func))
