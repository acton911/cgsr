...
from windows_lowpower import WindowsLowPower
import sys
import pickle
...
# debug
all_logger.info("WindowsLowPower: {} , type{}".format(WindowsLowPower, type(WindowsLowPower)))
...
exec("WindowsLowPower(**{}).{}()".format(params_dict, func))
