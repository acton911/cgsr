...
from utils.cases.windows10_esim_manager import Windows10EsimManager


class WindowsEsim(Windows10EsimManager):
    ...
    def windows_esim_7(self):
        """
        激活Profile过程中重启模块确认重启后Profile激活正常
        :return:
        """
        self.check_profile_exist()
        self.pageMobileBroadband.click_esim_profile()
    ...
    def windows_esim_14(self):
        ...
        try:
            ...
            try:
                self.page_main.click_network_icon()
                self.click_disable_airplane_mode_and_check()  # 确保退出飞行模式
    ...
    def windows_esim_28(self):
        ...
        try:
            ...
            self.cfun_1_1()
            self.pageMobileBroadband.esim_back()
            self.pageMobileBroadband.click_advanced_operation()  # 点击高级选项进入
...
if __name__ == '__main__':
    esim = WindowsEsim('COM23', 'COM22', 'RM502Q-AE',
                       profile_info='1$trl.prod.ondemandconnectivity.com$A3RVL9D392R9HAZC, 8988247000111689791,'
                       '1$trl.prod.ondemandconnectivity.com$9WFUMMWVP2FVKP4A, 8988247000111909454,'
                       '1$trl.prod.ondemandconnectivity.com$TVQQA2BY4RZF27MH, 8988247000111819885')
    esim.windows_esim_5()
