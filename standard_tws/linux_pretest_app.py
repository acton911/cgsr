...
from linux_pretest import LinuxPretest
...
# debug
all_logger.info("LinuxPretest: {} , type{}".format(LinuxPretest, type(LinuxPretest)))
...
exec("LinuxPretest(**{}).{}()".format(params_dict, func))
