...
from linux_cloud_ota import LinuxCloudOTA
import sys
import pickle
...
# debug
all_logger.info("LinuxCloudOTA: {} , type{}".format(LinuxCloudOTA, type(LinuxCloudOTA)))
...
dev_manufacturer_model = args_5g.dev_manufacturer_model
prev_ati = args_5g.prev_ati
ati = args_5g.ati
prev_sub = args_5g.prev_csub
sub = args_5g.csub
imei = args_5g.dev_imei_1
...
params_dict = {
    ...
    "module_model": dev_manufacturer_model,
    "prev_ati": prev_ati,
    "ati": ati,
    "prev_sub": prev_sub,
    "sub": sub,
...
exec("LinuxCloudOTA(**{}).{}()".format(params_dict, func))
