...
from linux_rtl8125 import LinuxRTL8125
import sys
import pickle
...
# debug
all_logger.info("LinuxRTL8125: {} , type{}".format(LinuxRTL8125, type(LinuxRTL8125)))
...
# 从args_5g中取出对应参数
pc_ethernet_name = args_5g.dev_pc_ethernet_name   # 内网网卡名
...
params_dict = {
    ...
    "rtl8125_ethernet_name": rtl8125_ethernet_name,  # RTL8125网卡名
    "phone_number": phone_number,
    "pc_ethernet_name": pc_ethernet_name,  # 内网网卡名
}
...
try:
    ...
    # 启用RTL8125网卡
    enable_network_card(rtl8125_ethernet_name)
    ...
    # 禁用RTL8125网卡
    disable_network_card(rtl8125_ethernet_name)
    # 启用公司网络
