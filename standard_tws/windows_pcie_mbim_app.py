...
from windows_pcie_mbim import WindowsPCIEMBIM
...
# debug
all_logger.info("WindowsPCIEMBIM: {} , type{}".format(WindowsPCIEMBIM, type(WindowsPCIEMBIM)))
...
try:
    ...
    exec("WindowsPCIEMBIM(**{}).{}()".format(params_dict, func))
