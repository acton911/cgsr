...
from linux_pcie_mbim import LinuxPcieMBIM
import sys
import pickle
...
# debug
all_logger.info("LinuxPcieMBIM: {} , type{}".format(LinuxPcieMBIM, type(LinuxPcieMBIM)))
...
exec("LinuxPcieMBIM(**{}).{}()".format(params_dict, func))
