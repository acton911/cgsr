...
# debug
all_logger.info("linuxAPNandAuthFunctions: {} , type{}".format(linuxAPNandAuthFunctions, type(linuxAPNandAuthFunctions)))
...
exec("linuxAPNandAuthFunctions(**{}).{}()".format(params_dict, func))
