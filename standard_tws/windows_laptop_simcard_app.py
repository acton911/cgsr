...
from windows_laptop_simcard import WindowsLaptopSimcard
import time
import sys
import os
import pickle
...
# debug
all_logger.info("WindowsLaptopSimcard: {} , type{}".format(WindowsLaptopSimcard, type(WindowsLaptopSimcard)))
...
try:
    ...
    exec("WindowsLaptopSimcard(**{}).{}()".format(params_dict, func))
