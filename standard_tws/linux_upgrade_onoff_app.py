...
from linux_upgrade_onoff import LinuxUpgradeOnOff
...
# debug
all_logger.info("LinuxUpgradeOnOff: {} , type{}".format(LinuxUpgradeOnOff, type(LinuxUpgradeOnOff)))
...
exec("LinuxUpgradeOnOff(**{}).{}()".format(params_dict, func))
