...
from linux_pcie_dfota import LinuxPCIEDFOTA
...
# debug
all_logger.info("LinuxPCIEDFOTA: {} , type{}".format(LinuxPCIEDFOTA, type(LinuxPCIEDFOTA)))
...
exec("LinuxPCIEDFOTA(**{}).{}()".format(params_dict, func))
