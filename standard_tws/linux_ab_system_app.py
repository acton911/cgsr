...
from linux_ab_system import LinuxABSystem
...
# debug
all_logger.info("LinuxABSystem: {} , type{}".format(LinuxABSystem, type(LinuxABSystem)))
...
exec("LinuxABSystem(**{}).{}()".format(params_dict, func))
