...
from windows_dfota import WindowsDFOTA
...
# debug
all_logger.info("WindowsDFOTA: {} , type{}".format(WindowsDFOTA, type(WindowsDFOTA)))
...
exec("WindowsDFOTA(**{}).{}()".format(params_dict, func))
