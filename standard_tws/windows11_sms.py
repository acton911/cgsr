from utils.cases.windows11_sms_manager import WindowsSMSManager
...
if __name__ == '__main__':
    # test = WindowsSMS('COM8', 'COM5', 'COM39', '15655129469', 'RG500Q-EA', 'CU')
    # test.test_windows_sms_15()
    # test.test_windows_sms_16()
    # test.test_windows_sms_17()
    # test.test_windows_sms_18()
    # test.test_windows_sms_19()
    # test.test_windows_sms_01()
    # test.test_windows_sms_02()
    # test.test_windows_sms_03()
    # test.test_windows_sms_15()
    # test.test_windows_sms_04()
    # test.test_windows_sms_05()
    # test.test_windows_sms_06()
    # test = WindowsSMS('COM8', 'COM5', 'COM39', '15655129469', 'RG500Q-EA', 'CU')
    # test.test_windows_sms_07()
    # test = WindowsSMS('COM8', 'COM5', 'COM39', '15655129469', 'RG500Q-EA', 'CU')
    # test.test_windows_sms_08()
    # test = WindowsSMS('COM8', 'COM5', 'COM39', '15655129469', 'RG500Q-EA', 'CU')
    # test.test_windows_sms_09()
    # test = WindowsSMS('COM8', 'COM5', 'COM39', '15655129469', 'RG500Q-EA', 'CU')
    # test.test_windows_sms_10()
    # test = WindowsSMS('COM8', 'COM5', 'COM39', '15655129469', 'RG500Q-EA', 'CU')
    # test.test_windows_sms_11()
    # test = WindowsSMS('COM8', 'COM5', 'COM39', '15655129469', 'RG500Q-EA', 'CU')
    # test.test_windows_sms_12()
    # test = WindowsSMS('COM8', 'COM5', 'COM39', '15655129469', 'RG500Q-EA', 'CU')
    # test.test_windows_sms_13()
    # test = WindowsSMS('COM8', 'COM5', 'COM39', '15655129469', 'RG500Q-EA', 'CU')
    # test.test_windows_sms_15()
    # test = WindowsSMS('COM8', 'COM5', 'COM39', '15655129469', 'RG500Q-EA', 'CU')
    # test.test_windows_sms_16()
    ...
    # test.test_windows_sms_19()
    # test = WindowsSMS('COM8', 'COM5', 'COM39', '15655129469', 'RG500Q-EA', 'CU')
    # test.test_windows_sms_20()
    # test = WindowsSMS('COM8', 'COM5', 'COM39', '15655129469', 'RG500Q-EA', 'CU')
    # test.test_windows_sms_21()
    test = WindowsSMS('COM8', 'COM5', 'COM39', '15655129469', 'RM520NGL', 'CU')
    test.test_windows_sms_31()
