...
from linux_mbim import LinuxMBIM
import sys
import pickle
...
# debug
all_logger.info("LinuxMBIM: {} , type{}".format(LinuxMBIM, type(LinuxMBIM)))
...
imei_number = main_device['imei_number']
...
exec("LinuxMBIM(**{}).{}()".format(params_dict, func))
