...
from linux_lowpower import LinuxLowPower
import sys
import pickle
...
# debug
all_logger.info("LinuxLowPower: {} , type{}".format(LinuxLowPower, type(LinuxLowPower)))
...
exec("LinuxLowPower(**{}).{}()".format(params_dict, func))
