...
class LogThread(Thread):
    ...
    def init_log_dir(self, info):
        ...
        init_df_column = ['local_time', 'runtimes', 'send_package_number', 'recv_package_number', 'lost_package_number',
                          ...
                          'dial_connect_time', 'dial_fail_times', 'ip_error_times', 'ping_fail_times',
                          'ip_address', 'qtemp_list', 'qftest_record', 'cefs_erase_times', 'usrdata_erase_times']
    ...
    def write_result_log(self, runtimes):
        ...
        if self.restart_mode == 1 or self.restart_mode == 2:
            result_width_standard = {0: ['local_time', 25], 1: ['runtimes', 8],
                                     ...
                                     10: ['ip_address', 22], 11: ['qtemp_list', 50], 12: ['cefs_erase_times', 10],
            ...
            result_width_standard = {0: ['local_time', 25], 1: ['runtimes', 8],
                                     ...
                                     6: ['shortest_time', 13], 7: ['longest_time', 12],
                                     8: ['average_time', 12], 9: ['ping_fail_times', 15],
                                     10: ['ip_address', 22], 11: ['qtemp_list', 50], 12: ['cefs_erasetimes', 10],
                                     13: ['usrdata_erasetimes', 10]}
        ...
        if self.restart_mode == 1 or self.restart_mode == 2:
            ...
            result_list = [local_time, runtimes, send_package_number, recv_package_number,
                       lost_package_number, lost_package_percentage,
                       shortest_time, longest_time, average_time, ping_fail_times, ip_address, qtemp_list, cefs_erase_times, usrdata_erase_times]
            ...
            result_list = [local_time, runtimes, send_package_number, recv_package_number,
                       lost_package_number, lost_package_percentage,
                       shortest_time, longest_time, average_time, ping_fail_times, ip_address, qtemp_list, cefs_erasetimes, usrdata_erasetimes]
